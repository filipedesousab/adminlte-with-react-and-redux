...
storiesOf('ui-elements/form/Select [Select, UIE012]', module)
  ...
  .add('label', () => (
    <Select label={<Label icon="fa fa-smile-o">Um label com icon</Label>} />
  ), {
  ...
  .add('label com form', () => (
    <Select label={<Label form icon="fa fa-smile-o">Um label com props form</Label>} />
  ), {
  ...
  .add('helpBlock', () => (
    <Select
      label={<Label>Select com helpBlock</Label>}
  ...
  .add('helpBlock Label', () => (
    <Select
      label={<Label>Select com helpBlock Label</Label>}
  ...
  .add('options com id', () => (
    <Select
      label={<Label>Select opções com id</Label>}
      options={[
  ...
  .add('btnLeft', () => [
    ...
    <React.Fragment key={index.toString()}>
      <Select
        label={<Label>Select com {button.type.name} no lado esquerdo</Label>}
        options={[
          { value: 'op1', label: 'Opção 1' },
          { value: 'op2', label: 'Opção 2' },
        ]}
  ...
  .add('btnRight', () => [
    ...
    <React.Fragment key={index.toString()}>
      <Select
        label={<Label>Select com {button.type.name} no lado direito</Label>}
        options={[
          { value: 'op1', label: 'Opção 1' },
          { value: 'op2', label: 'Opção 2' },
        ]}
  ...
  .add('btnLeft, btnRight e state', () => [
    ...
    <React.Fragment key={index.toString()}>
      <Select
        label={<Label>Select com button nos dois lados e state</Label>}
        options={[
          { value: 'op1', label: 'Opção 1' },
          { value: 'op2', label: 'Opção 2' },
        ]}
  ...
  .add('btnLeft, btnRight e size', () => [
    ...
    <React.Fragment key={index.toString()}>
      <Select
        label={<Label>Select com size {`${value.size}`}</Label>}
        options={[
          { value: 'op1', label: 'Opção 1' },
          { value: 'op2', label: 'Opção 2' },
        ]}
  ...
  .add('addonLeft', () => [
    ...
    <React.Fragment key={index.toString()}>
      <Select
        label={<Label>Select com {typeof addon === 'string' ? addon : addon.type.name} no lado esquerdo</Label>}
        options={[
          { value: 'op1', label: 'Opção 1' },
          { value: 'op2', label: 'Opção 2' },
        ]}
  ...
  .add('addonRight', () => [
    ...
    <React.Fragment key={index.toString()}>
      <Select
        label={<Label>Select com {typeof addon === 'string' ? addon : addon.type.name} no lado direito</Label>}
        options={[
          { value: 'op1', label: 'Opção 1' },
          { value: 'op2', label: 'Opção 2' },
        ]}
  ...
  .add('addonLeft, addonRight e state', () => [
    ...
    <React.Fragment key={index.toString()}>
      <Select
        label={<Label>Select com {typeof value.addon === 'string' ? value.addon : value.addon.type.name} no lado direito</Label>}
        options={[
          { value: 'op1', label: 'Opção 1' },
          { value: 'op2', label: 'Opção 2' },
        ]}
  ...
  .add('addons, buttons e state', () => [
    ...
    <React.Fragment key={index.toString()}>
      <Select
        label={<Label>Select com botão e addon nos dois lados</Label>}
        options={[
          { value: 'op1', label: 'Opção 1' },
          { value: 'op2', label: 'Opção 2' },
        ]}
  ...
  .add('value com onChange', () => (
    <Select
      label={<Label>Select com value</Label>}
      options={[
        { value: 'op1', label: 'Opção 1' },
        { value: 'op2', label: 'Opção 2' },
      ]}
  ...
  .add('defaultValue', () => (
    <Select
      label={<Label>Select com defaultValue</Label>}
      options={[
        { value: 'op1', label: 'Opção 1' },
        { value: 'op2', label: 'Opção 2' },
      ]}
